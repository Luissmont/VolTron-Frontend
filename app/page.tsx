    ...
    <main className="min-h-screen bg-shadow-grey text-bright-snow p-4 md:p-8 font-sans">
      <div className="w-full max-w-screen-2xl mx-auto">
        ...
        <header className="mb-10 pb-4 border-b border-iron-grey">
          ...
          <p className="text-slate-grey mt-1">Catalogo de piezas disponibles para tu circuito.</p>
        </header>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
          {lista_componentes.map((componente_actual) => (
            <article
              ...
              className="flex flex-row bg-gunmetal border border-iron-grey/60 rounded-2xl shadow-lg hover:shadow-xl hover:-translate-y-1 transition-all duration-300 overflow-hidden"
            >

              <div className="w-1/3 bg-shadow-grey/60 p-4 flex flex-col justify-center items-center border-r border-iron-grey/40 rounded-l-2xl">
